...
<form id="form" enctype="multipart/form-data">
    ...
    미리보기 : <img id="preview" width="50" height="50" src="" alt="미리보기"/><br/>
    ...
    카테고리 : <select name="category_id" id="category_id"> </select>
    <br>
    ...
    $(document).ready(
        $.ajax({
            ...
            for (i = 0; i < result.data.length; i++)
                $('#category_id').append("<option value='" + result.data[i].categoryId + "'>"
